    ...
    $(".switch-control input[type=checkbox]").change(function() {
        ...
        switch (boxId) {
            ...
            case "radio-push-talk":
                ...
                storage.radioSettingPushToTalk = $("#radio-push-talk").prop("checked")
                ChangeToPushToTalk(storage.radioSettingPushToTalk)
                break;
            case "radio-perm-talk":
                ...
                storage.radioSettingFullsend = $("#radio-perm-talk").prop("checked")
                ChangeToFullSend(storage.radioSettingFullsend)
                break;
            default:
                break;
        }
